...
Begin WebContainer UserManageBoard
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
   ...
   _mDesignWidth   =   0
   _mPanelIndex    =   -1
   Begin WebLabel UserManageTitle
      Bold            =   True
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin WebListBox UserList
      ...
      Index           =   -2147483648
      Indicator       =   0
      InitialValue    =   "Name	Type	Tickets\r\nKhem	Adminstrator	257\r\nEye	Adminstrator	192\r\nAom	Support	120\r\nGame	ETL	35"
      LastAddedRowIndex=   0
      LastColumnIndex =   0
      LastRowIndex    =   0
      Left            =   20
   ...
   Begin WebButton AddUser
      ...
      _mPanelIndex    =   -1
   End
   Begin AddUserPopup AddUserPopup1
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      Height          =   390
