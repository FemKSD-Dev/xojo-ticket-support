...
Begin WebContainer TypeProblemControlBoard
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
   ...
   _mDesignWidth   =   0
   _mPanelIndex    =   -1
   Begin WebLabel TypeProblemTitle
      Bold            =   True
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin WebButton AddType
      ...
      _mPanelIndex    =   -1
   End
   Begin AddTypePopup AddTypePopup1
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      Height          =   220
